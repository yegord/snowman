...
#define elf32_ia64_hash_table(p) \
  ...
  == IA64_ELF_DATA ? ((struct elf32_ia64_link_hash_table *) ((p)->hash)) : NULL)
...
static bfd_boolean allocate_local_got
  (struct elf32_ia64_dyn_sym_info *dyn_i, void * data);
static bfd_boolean elf32_ia64_hpux_vec
...
{
  bfd_reloc->howto
    = ia64_elf_lookup_howto ((unsigned int) ELF32_R_TYPE (elf_reloc->r_info));
}

...
static bfd_boolean
elf32_ia64_section_flags (flagword *flags,
...
static bfd_boolean
elf32_ia64_modify_program_headers (bfd *abfd,
				   struct bfd_link_info *info ATTRIBUTE_UNUSED)
{
...
static bfd_boolean
elf32_ia64_global_dyn_info_free (void **xentry,
...
static bfd_boolean
elf32_ia64_global_dyn_sym_thunk (struct bfd_hash_entry *xentry,
				 void * xdata)
{
  struct elf32_ia64_link_hash_entry *entry
    = (struct elf32_ia64_link_hash_entry *) xentry;
...
static bfd_boolean
elf32_ia64_choose_gp (bfd *abfd, struct bfd_link_info *info, bfd_boolean final)
{
...
static bfd_boolean
elf32_ia64_merge_private_bfd_data (bfd *ibfd, bfd *obfd)
{
  flagword out_flags;
  flagword in_flags;
  bfd_boolean ok = TRUE;
...
static void
elf32_hpux_post_process_headers (bfd *abfd,
				 struct bfd_link_info *info ATTRIBUTE_UNUSED)
{
...
#define elf_backend_modify_program_headers \
	elf32_ia64_modify_program_headers
...
#define elf_backend_post_process_headers elf32_hpux_post_process_headers
