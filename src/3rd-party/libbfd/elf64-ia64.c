...
static bfd_boolean allocate_local_got
  (struct elf64_ia64_dyn_sym_info *dyn_i, void * data);
static bfd_boolean elf64_ia64_hpux_vec
...
static bfd_boolean
elf64_ia64_modify_program_headers (bfd *abfd,
				   struct bfd_link_info *info ATTRIBUTE_UNUSED)
{
...
static void
elf64_hpux_post_process_headers (bfd *abfd,
				 struct bfd_link_info *info ATTRIBUTE_UNUSED)
{
...
#define elf_backend_modify_program_headers \
	elf64_ia64_modify_program_headers
...
#define elf_backend_post_process_headers elf64_hpux_post_process_headers
