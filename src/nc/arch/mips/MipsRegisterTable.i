...
REG(t8,     T8, 	0,  24,	32, "Temporary register (not preserved)")
REG(t9,     T9, 	0,  25,	32, "Temporary register (not preserved)")
...
REG(s8,     S8, 	0,  30,	32, "Calle saved register / frame pointer")
